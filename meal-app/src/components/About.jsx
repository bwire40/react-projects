      ...
      <section className="bg-white py-8">
        <div className="container py-8 px-6 mx-auto">
          ...
          <p className="mt-8 mb-8">
            Incididunt nisi ex quis minim dolore enim aliquip laboris fugiat
            laboris. Reprehenderit consequat magna eu deserunt labore tempor
            mollit. Laboris voluptate tempor voluptate laborum veniam consequat.
            <br />
          </p>
          ...
          <p className="mb-8">
            ...
            aliquam sem et tortor consequat. Eget mi proin sed libero enim seda
